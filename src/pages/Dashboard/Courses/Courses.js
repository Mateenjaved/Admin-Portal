...
import { Button, Col, DatePicker, Divider, Form, Image, Input, Modal, Row, Space, Tooltip, message } from 'antd'
...
export default function Students() {
  ...
  const initialState = { title: "", location: "", date: "" }
  ...
  const handleSubmit = async (e) => {
    ...
    const handleDelete = async (todo) => {
      ...
      try {
        await deleteDoc(doc(firestore, "Courses", todo.id));
          ...
          <div className="container">
            <div className="row ">
              ...
              <div className='col-12 text-end'>
                <Link onClick={() => { setIsModalOpen(true) }} className='btn btn-primary mb-5'>Add Course</Link>
              </div>
            </div>
            <Divider />
                  ...
                  <Row gutter={16}>
                    <Col xs={24} lg={12}>
                      <Form.Item label="Title">
                        <Input placeholder='Input Course Title' name='title' onChange={handleChange} />
                      </Form.Item>
                    </Col>
                    <Col xs={24} lg={12}>
                      <Form.Item label="Course Duration">
                        <Input placeholder='Input Course Duration' name='location' onChange={handleChange} />
                      </Form.Item>
                    </Col>
                    <Col xs={24} lg={12}>
